 ...
 */
function findClosestDomain(domain: string, maxDistance: number = 2): string | null {
 ...
 */
export function getEmailSuggestion(email: string): SuggestionResult {
 ...
 */
export function getSuggestedEmail(email: string): string {
