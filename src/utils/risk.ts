 ...
 */
export function analyzeRisk(email: string): RiskAnalysisResult {
 ...
 */
export function isHighRisk(email: string): boolean {
 ...
 * Get risk score only
 */
export function getRiskScore(email: string): number {
