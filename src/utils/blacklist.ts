 ...
 */
async function checkIpInDnsbl(ip: string, blacklist: string): Promise<boolean> {
 ...
 */
async function checkDomainInDbl(domain: string, blacklist: string): Promise<boolean> {
 ...
 */
async function getMxServerIps(domain: string): Promise<string[]> {
  try {
 ...
 */
export async function getDomainReputationScore(domain: string): Promise<number> {
 ...
 */
export function getAvailableBlacklists(): { dns: string[]; domain: string[] } {
  return {
    dns: [...DNS_BLACKLISTS],
